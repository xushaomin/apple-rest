 ...
 * @version 1.0
 */
public class DefaultRestContextTest {
	...
	public void testWithoutGroupService() {
		...
		RestContext registryMethod = new DefaultRestContext(context);
	...
	public void testWithGroupService() {
		...
		RestContext restContext = new DefaultRestContext(context);

		// method1:都在ServiceMethodGroup中定义，在ServiceMethod中直接采用
		ServiceMethodHandler handler = restContext.getServiceMethodHandler("service.method1");
		ServiceMethodDefinition definition = handler.getServiceMethodDefinition();
		assertNotNull(definition);
		assertEquals(definition.getMethod(), "service.method1");
		assertEquals(definition.getMethodTitle(), "测试方法1");
		...
		ServiceMethodHandler handler2 = restContext.getServiceMethodHandler("service.method2");
	...
	public void testIngoreSignField() {
		...
		Class serviceClass = IgnoreSignRestRequestService.class;
		when(context.getType("method1")).thenReturn(serviceClass);

		RestContext restContext = new DefaultRestContext(context);

		ServiceMethodHandler method1 = restContext.getServiceMethodHandler("method1");
	...
	@ServiceMethodBean
	public class IgnoreSignRestRequestService {

		@ServiceMethod(method = "method1")
		public Object method1(FooRestRequest request) {
			return null;
		}
	}

	public class FooRestRequest extends AbstractRestRequest {
	...
	public class WithoutGroupService {
		...
		@ServiceMethod(method = "service.method1", title = "测试方法1", group = "GROUP1", groupTitle = "分组1", tags = {
				"TAG1",
				"TAG2" }, timeout = 100)
	...
	@ServiceMethodBean(group = "GROUP1", groupTitle = "分组1", tags = { "TAG1", "TAG2" }, timeout = 100)
	public class WithGroupService {

		@ServiceMethod(method = "service.method1", title = "测试方法1")
		public Object service1() {
			return null;
		}

		@ServiceMethod(method = "service.method2", title = "测试方法2", group = "GROUP2", groupTitle = "分组2", tags = {
				"TAG11",
				"TAG21" }, timeout = 200)
